			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-sm-pull-6">
					<div class="mu-hero-left">
						<h1>Sebuah Ecommerce yang Menjual Berbagai Macam Buku</h1>
						...
						<a href="#" class="mu-primary-btn">Pesan Sekarang!</a>
						<span>*Tersedia berbagai macam Buku, Komik, E-Book, hingga Majalah.</span>
					</div>
				</div>
			</div>
		</div>
		...
		<section id="mu-google-map">
			<div class="mapouter">
				<div class="gmap_canvas">
					<iframe width="100%" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=teja%20buana&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
				</div>
			</div>
		</section>
		<!-- End Google Map -->
